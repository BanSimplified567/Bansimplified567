      ...
      <main className="section">
        <div className="contact">
          ...
          <motion.section { ...animationProps } className="contactSendMessage">
            ...
            <motion.div { ...animationProps } className="contact-container">
              <div className="contact-wrapper">
                <div className="contact-info-section">
                  <h1 className="contact-title">Contact Information</h1>
                  <p className="contact-detail">Name: Jade Ivan V. Bringcola (Ban Ban)</p>
                  <p className="contact-detail">Location: Sibonga, Cebu, Philippines</p>
                  <p className="contact-detail">Number: +63 93 1028 2926</p>
                  <p className="contact-detail">Email: bansimplified567@gmail.com</p>
                </div>
                <div className="contact-help-section">
                  <h1 className="contact-title">What Can We Help You?</h1>
                  <p className="contact-help-text">
                    Please follow my social media to get in touch with me and learn more about me.
                  </p>
                </div>
                <motion.div { ...animationPropsUp } className="contact-social-section">
